...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="AuRevoir(design1,blck)2.png" width="100%" id="mainImg">

            <div class="small-image-group">
                <div class="small-img-col">
                    <img src="AuRevoir(design1,blck)2.png" width="150%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="auww.png" width="150%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="auw.png" width="150%" class="small-img">
                </div>

                <div class="small-img-col">
                    <img src="ausz.jpg.png" width="150%" class="small-img">
                </div>
             </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="title">Regular Tee AuRevoir - Every Butterfly You See</div>
            ...
            <div class="size-section">
                ...
                <div class="size-options">
                    <div class="size-option">
                        <span>M</span>
                        <span>Rp 125,000 (Stok Habis)</span>
                        <button>
                        Beli
                    </button>
...
<div class="modal fade" id="modalBeli" tabindex="-1" aria-labelledby="modalBeliLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <div class="size-option">
                        <span>L</span>
                        <span>Rp 125,000 (Stok Habis)</span>
                        <button id="modalTambah">Beli</button>
                    </div>
                    <div class="size-option">
                        <span>XL</span>
                        <span>Rp 125,000 (Stok Habis)</span>
            ...
            <div class="notify-btn">Detail Produk : <br> <br> Bahan : Cotton Combed 20s <br> Gramasi : 210gsm <br> Sablon : Plastisol Raster <br><br><br>
            "Every Butterfly You See" desain pada kaos ini memiliki makna kemanapun ia pergi ketika melihat seseorang yang ada diingatan hanyalah orang yang ia sayangi.
            </div>
        </div>
    </section>
